...
<div class="container-fluid">
    <div class="row" style="margin-top: 40px;">
        <div class="col-lg-4 ">
            <input type="text" class="form-control" id="validationDefault01" placeholder="Pesquisar Categoria">
        </div>
    </div>
</div>
<div class="cards-category-list">
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <form action="{{ route('createProviderCategory') }}" method="POST">
                @csrf
...
@endsection
@section('addjs')
<script type="text/javascript" src="{{asset('assets/js/myEvent/categoryProviderEdit.js')}}"></script>
